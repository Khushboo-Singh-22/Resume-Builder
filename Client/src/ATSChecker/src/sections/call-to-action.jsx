export default function CallToAction() {
  return (
    <section className="flex flex-col items-center justify-center max-w-7xl mx-auto my-0 px-4 mt-32 mb-10">

      <h3 className="font-domine text-3xl max-w-m text-center bg-linear-to-r from-gray-800 to-gray-500 bg-clip-text text-transparent">
        Get Your Resume ATS-Ready in Seconds
      </h3>

      <p className="mt-4 text-sm/6 text-gray-500 max-w-m text-center">
        Upload your resume and job description to instantly check your ATS score, find missing keywords, and improve your chances of getting shortlisted.
      </p>
