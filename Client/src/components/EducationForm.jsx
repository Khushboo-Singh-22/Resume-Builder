          ...
          {data.map((education, index) => (
            <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
              ...
              <div className='grid md:grid-cols-2 gap-3'>
                ...
                <input value={education.degree|| ""} onChange={(e) => updateEducation(index, "degree", e.target.value)} type="text" placeholder="Degree (e.g,Bachelor's , Masters's)" className="px-3 py-2 text-sm " />
                ...
                <input value={education.gradution_date || ""} onChange={(e) => updateEducation(index, "gradution_date", e.target.value)} type="month"  className="px-3 py-2 text-sm  " />
              </div>
